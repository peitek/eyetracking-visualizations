...
def draw_plot(input_file, output_file):
    ...
    barplot = sns.barplot(y="aoi_inner", x="snippet", data=aoi_participant_data, label="Inner AOI", color=colors[0])

    # Add a legend and informative axis label
    ax.legend(loc="upper left")
    ax.set(ylim=(0), xlabel="Comprehension Snippets", ylabel="Fixation Count in AOIs around Task Identifier")
